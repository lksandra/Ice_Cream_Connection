...
export class CustomerDashboardComponent implements OnInit {
  ...
  mapFindHelper(truck_id : Number ) : boolean{
    ...
    console.log('mapFIndhelper: bookedbatch has ', truck_id, " ?: ", this.currentBookedBatchOfTrucks.has(JSON.stringify(truck_id)));
    console.log('mapFIndhelper: bookedbatch data:\n', this.currentBookedBatchOfTrucks);
    var temp = this.currentBookedBatchOfTrucks.get(JSON.stringify(truck_id));
    console.log('mapFindeHelper:temp: ', temp);
    var temp2 = this.currentAcknowledgedBatchOfTrucks.get(truck_id);
  ...
  mapFindHelper2(truck_id : Number) : boolean{
    ...
    console.log('mapFIndhelper2: bookedbatch has ', truck_id, " ?: ", this.currentBookedBatchOfTrucks.has(truck_id));
    console.log('mapFIndhelper2: bookedbatch data:\n', this.currentBookedBatchOfTrucks);
    let temp3 = this.currentBookedBatchOfTrucks.get(truck_id);
  ...
  mapFIndHelper3(truck_id : Number) : boolean{
    ...
    console.log('mapFIndhelper3: ackd batch has ', truck_id, " ?: ", this.currentAcknowledgedBatchOfTrucks.has(truck_id));
    console.log('mapFIndhelper3: ackd batch data:\n', this.currentAcknowledgedBatchOfTrucks);
    let temp4 = this.currentAcknowledgedBatchOfTrucks.get(truck_id);
        ...
        this.currentBookedBatchOfTrucks.forEach((val, ky, store)=>{
          ...
          for(let eachCus of allCusData.customers){
            ...
            if(eachCus.served_by_id==ky){
              this.currentBookedBatchOfTruckInfoWindows.get(ky).setContent("Truck Will Deliver Soon!");
              let tempTruckInfoWindow = this.currentBookedBatchOfTruckInfoWindows.get(ky);
              console.log('pollForBookedTruckAck: temptruckinfowindow\n', tempTruckInfoWindow );
              
              let tempTruckMarker = this.currentBookedBatchOfTrucks.get(ky);
              console.log('pollForBookedTruckAck: temptruckmarker\n', tempTruckMarker);
              console.log('moving infowindwo from booked to ackd\n', this.currentAcknowledgedBatchOfTruckInfoWindows.set(ky, tempTruckInfoWindow));
              console.log('moving marker from booked to ackd\n', this.currentAcknowledgedBatchOfTrucks.set(ky, tempTruckMarker));
              console.log('removing marker '+ ky +'from booked');
              console.log(this.currentBookedBatchOfTrucks.delete(ky));
              console.log('removing infowindow from booked\n', this.currentBookedBatchOfTruckInfoWindows.delete(ky) );
        ...
        if(allCustomers.success==true){
          ...
          for(let eachCus of allCustomers.customers){
            if(eachCus.served_by_id==ky){
              ...
              let tempTruckInfoWindow = this.currentBookedBatchOfTruckInfoWindows.get(ky);
              let tempTruckMarker = this.currentBookedBatchOfTrucks.get(ky);
              console.log('moving infowindwo from booked to ackd\n', this.currentBookedBatchOfTruckInfoWindows.set(ky, tempTruckInfoWindow));
              console.log('moving marker from booked to ackd\n', this.currentAcknowledgedBatchOfTrucks.set(ky, tempTruckMarker));
              console.log('removing marker '+ ky +'from booked');
              console.log(this.currentBookedBatchOfTrucks.delete(ky));
              console.log('removing infowindow from booked\n', this.currentBookedBatchOfTruckInfoWindows.delete(ky) );
